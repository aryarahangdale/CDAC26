...
public:
    ...
    // Business logic functions (const)
    double computeAllowances() const {
        double allowancePercent = 0;
        switch (grade) {
            case 'A':
                allowancePercent = 0.40;  // 40%
                break;
            case 'B':
                allowancePercent = 0.30;  // 30%
                break;
            case 'C':
                allowancePercent = 0.20;  // 20%
                break;
            case 'D':
                allowancePercent = 0.10;  // 10%
                break;
        }
...
int main() {
    ...
    // Uncomment below to observe compiler errors:
    // e1.empId = 999;  // ERROR: 'empId' is a private member
    // e1.basicSalary = -1000;  // ERROR: 'basicSalary' is a private member
    // Private members are hidden and cannot be accessed directly from main()
    // We must use public setters/getters for validation and access control
